        ...
        var e = function(a, i, n, u) {
            ...
            x = function(a, i) {
                ...
                if (u) {
                    ...
                    var S = w.cloneNode(),
                        A;
                    S.src = yt(n, u.params.sitekey, u.params, (A = u.rcV) !== null && A !== void 0 ? A : J, !1, "g", a, g.scriptUrlParsed, dt(u)), (s = w.parentNode) === null || s === void 0 || s.replaceChild(S, w), Ft(h), u.retryTimeout && window.clearTimeout(u.retryTimeout)
            ...
            P = function(a, i) {
                ...
                if (de) {
                    ...
                    if (!(!Ne || !ge)) {
                        ...
                        at || m("Turnstile Initialization Error ", 3606), H.style.display = "none", H.style.border = "none", H.style.overflow = "hidden", H.setAttribute("src", yt(Ne, q, p, J, !1, "g", X.New, g.scriptUrlParsed, dt(at))), H.onerror = function() {
                            if (ce) {
                ...
                return Be(this, function(U) {
                    switch (U.label) {
                        case 0:
                            ...
                            h = "h/".concat("g", "/"), w = new URL(s), S = "https", A = "", W = "".concat(S, "://").concat(w.host, "/cdn-cgi/challenge-platform/").concat(h, "rc/").concat(n).concat(A), U.label = 1;
                        case 1:
            ...
            if (a.source === z) {
                ...
                if (!(!a.widgetId || !g.widgetMap.has(a.widgetId))) {
                    ...
                    if (!(!i || !n)) switch (a.event) {
                        case "init":
                            {
                                var u;n.widgetInitStartTimeTsMs = B(),
                                n.kills = a.kills;
                                var s = n.shadow.getElementById(i);s || m("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                                n.mode = a.mode,
                                n.nextRcV = a.nextRcV,
                                n.mode === G.Invisible && n.params["refresh-expired"] === ee.Manual && b("refresh-expired=manual is impossible in invisible mode, consider using '".concat(ee.Auto, "' or '").concat(ee.Never, ".'")),
                                n.mode !== G.Managed && n.params["refresh-timeout"] !== ue.Auto && b("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                n.params.appearance === K.Always || n.isExecuting && n.params.appearance === K.Execute ? Pt(s, n) : Ir(s),
                                s.style.display = "";
                                var h = n.shadow.querySelector("#".concat(i));h || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                (u = h.contentWindow) === null || u === void 0 || u.postMessage({
                                    event: "init",
                                    source: z,
                                    widgetId: a.widgetId
                                }, "*");
                        ...
                        case "translationInit":
                            {
                                var w = n.shadow.getElementById(i);w || m("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074);
                                var S = new Map;n.displayLanguage = a.displayLanguage,
                                n.displayRtl = a.displayRtl,
                                Object.keys(a.translationData).forEach(function(Z) {
                        ...
                        case "languageUnsupported":
                            {
                                b("Language ".concat(n.params.language, " is not supported, falling back to: ").concat(a.fallback, ".")),
                                n.displayLanguage = a.fallback;
                                break
                            }
                        case "reject":
                            {
                        ...
                        case "overrunBegin":
                            {
                                n.isOverrunning = !0,
                                n.watchcat && (n.watchcat.overrunBeginSeq = n.watchcat.lastAckedSeq);
                                break
                            }
                        case "overrunEnd":
                            {
                        ...
                        case "complete":
                            {
                                l(n, J, a.widgetId),
                                n.response = a.token,
                                a.sToken ? e(n, i, a.sToken, a.chlId) : r(n, i, !1);
                                break
                            }
                        case "fail":
                            {
                                a.rcV && l(n, a.rcV, a.widgetId),
                                a.cfChlOut && (n.cfChlOut = a.cfChlOut),
                                a.cfChlOutS && (n.cfChlOutS = a.cfChlOutS),
                                a.code && (n.errorCode = a.code),
                                n.isExecuting = !1,
                                n.isFailed = !0,
                                n.isInitialized = !0,
                                a.frMd && (n.frMd = a.frMd),
                                Ft(i);
                                var W = n.cbError,
                        ...
                        case "requestFeedbackData":
                            {
                                var ne, fe = n.shadow.querySelector("#".concat(i));fe || m("Received state for an unknown widget: #".concat(i, " / ").concat(a.widgetId), 3078),
                                (ne = fe.contentWindow) === null || ne === void 0 || ne.postMessage({
                        ...
                        case "turnstileResults":
                            {
                                var Ee, q, pe = (Ee = n.wrapper.parentNode) === null || Ee === void 0 ? void 0 : Ee.querySelector("#".concat(i, "-fr"));pe || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                (q = pe.contentWindow) === null || q === void 0 || q.postMessage({
                                    cfChlOut: n.cfChlOut,
                        ...
                        case "closeFeedbackReportIframe":
                            {
                                var ae, Te = (ae = n.wrapper.parentNode) === null || ae === void 0 ? void 0 : ae.querySelector("#".concat(i, "-fr"));Te || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                yr("".concat(i, "-fr"));
                                break
                            }
                        case "tokenExpired":
                            {
                                var ie, Se = a.token;n.isExpired = !0,
                                (ie = n.cbExpired) === null || ie === void 0 || ie.call(n, Se),
                                n.params["refresh-expired"] === ee.Auto && !n.isResetting && x(X.AutoExpire, i);
                                break
                            }
                        ...
                        case "reloadRequest":
                            {
                                l(n, a.nextRcV, a.widgetId),
                                x(a.trigger, i);
                                break
                            }
                        case "interactiveBegin":
                            {
                                var Re, Pe = n.shadow.getElementById(i);Pe || m("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                                (Re = n.cbBeforeInteractive) === null || Re === void 0 || Re.call(n),
                                n.params.appearance === K.InteractionOnly && Pt(Pe, n);
                                break
                            }
                        case "interactiveEnd":
                            {
                        ...
                        case "requestExtraParams":
                            {
                                var Ie;n.widgetParamsStartTimeTsMs = B();
                                var Ce = n.shadow.querySelector("#".concat(i));Ce || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                n.isResetting = !1;
                                var ce = {},
                                    tt = B(),
                                    Oe = {
